...
$("[data-aos]").parent().addClass("ofHie");
  AOS.init({
    offset: 20,
    duration: 1000,
    mirror: false,
...
$(document).ready(function() {
        ...
        onSliderLoad: function() {  
          $('#story-slider').removeClass('cS-hidden');
        }
    });
});

$(document).ready(function() {
        $("#our-values").lightSlider({
        item: 1,
        autoWidth: false,
        slideMove: 1, // slidemove will be 1 if loop is true
        slideMargin: 10,
        ...
        onSliderLoad: function() {  
          $('#our-values').removeClass('cS-hidden');
        }
    });
});
...
// Privacy Preferences Center in Modal
$(document).ready(function () {
      checkCheckboxes();
      $('.cooCheck').on('change', function () {
        checkCheckboxes();
      });
      function checkCheckboxes() {
        // Check if any checkbox is unchecked
        if ($('.cooCheck:not(:checked)').length > 0) {
          // Add class if any checkbox is unchecked
          $('.acceptSettings').addClass('show');
        } else {
          // Remove class if all checkboxes are checked
          $('.acceptSettings').removeClass('show');
        }
      }
    });
  ...
  $(document).ready(function () {
      $('.toggle-heading').on('click', function () {
          // Check if the window width is less than 1199 pixels
          if ($(window).width() < 992) {
              // Toggle the class on the sibling <p> element
              $(this).toggleClass('active');
              $(this).next('.toggle-p').toggleClass('show');
          }
      });
  });
  ...
  $(document).ready(function () {
      $('.faq-heading').on('click', function () {
          $(this).toggleClass('active');
          $(this).next('.faq-desc').slideToggle('fast');
      });
  });
  ...
  $(document).ready(function () {
      $('.navbar-toggler').on('click', function () {
          // Toggle class on body when navbar is opened
          $('header, section').toggleClass('bg-white');
